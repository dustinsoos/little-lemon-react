          ...
          <div className=" gap-4 lg:flex 2xl:gap-8">
            ...
            <div className="  mx-auto mt-8 w-4/5 rounded-2xl shadow-xl shadow-black/50 lg:w-1/3 ">
              ...
              <div className="p-4">
                ...
                <p className="mb-8 mt-4 text-lg lg:mb-24 xl:text-xl ">
                  Our Tomato soup is a vibrant and comforting dish that captures
                  the essence of Mediterranean flavors. This exquisite creation
                  is crafted with a blend of sun-kissed tomatoes & aromatic
                  herbs.
                </p>
                <Link
                  href="/orderonline"
            ...
            <div className="  mx-auto mt-8 w-4/5 rounded-2xl shadow-xl shadow-black/50 lg:w-1/3 ">
              ...
              <div className="p-4">
                ...
                <p className="mb-8 mt-4 text-lg lg:mb-24 xl:text-xl ">
                  Our Mediterranean Platter combines a tantalizing blend of
                  fresh grapes, crisp crackers, velvety hummus, succulent
                  sausage, and juicy apples to create a harmonious culinary
                  experience.
                </p>
                <Link
                  href="/orderonline"
          ...
          <div className=" gap-4 lg:flex 2xl:gap-8">
            <div className="  mx-auto mt-8 w-4/5 rounded-2xl shadow-xl shadow-black/50 lg:w-1/3">
              ...
              <div className="p-4">
                ...
                <p className="mb-8 mt-4 text-lg lg:mb-32 xl:text-xl ">
                  The famous Greek salad has crispy lettuce, peppers, olives and
            ...
            <div className="  mx-auto mt-8 w-4/5 rounded-2xl shadow-xl shadow-black/50 lg:w-1/3">
              ...
              <div className="p-4">
                ...
                <p className="mb-8 mt-4 text-lg lg:mb-24 xl:text-xl ">
                  ...
                  and a hint of garlic. This perfect combination infuses the
                  fish with layers of depth and complexity.
                </p>
                <Link
                  href="/orderonline"
                  className="block rounded border-2 border-ll-primaryGreen bg-ll-primaryGreen px-4 py-2 text-center font-bold text-white hover:bg-white hover:text-ll-primaryGreen"
          ...
          <div className=" gap-4 lg:flex 2xl:gap-8">
            ...
            <div className="  mx-auto mt-8 w-4/5 rounded-2xl shadow-xl shadow-black/50 lg:w-1/3">
              ...
              <div className="p-4">
                ...
                <p className="mb-8 mt-4 text-lg lg:mb-40 xl:text-xl ">
                  Indulge in a decadent journey of chocolate bliss with our
                  exquisite Chocolate Truffles dessert, a heavenly creation that
                  adds a touch of Mediterranean flair to this classic
                  confection.
                </p>
                <Link
                  href="/orderonline"
            ...
            <div className="  mx-auto mt-8 w-4/5 rounded-2xl shadow-xl shadow-black/50 lg:w-1/3">
              ...
              <div className="p-4">
                ...
                <p className="mb-8 mt-4 text-lg lg:mb-36 xl:text-xl ">
                  Crafted with utmost care and attention, our Caramel Ice Cream
                  begins with a luscious, creamy base that is made using the
                  finest ingredients. We start by simmering sweetened milk and
                  cream until they reach the perfect consistency.
                </p>
                <Link
                  href="/orderonline"
                  className="block rounded border-2 border-ll-primaryGreen bg-ll-primaryGreen px-4 py-2 text-center font-bold text-white hover:bg-white hover:text-ll-primaryGreen"
