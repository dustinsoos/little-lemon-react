  ...
  return (
    <>
      <main className="">
        <section className="mt-12 bg-ll-primaryGreen">
          <div className=" items-center justify-between px-4 pb-14 pt-14  text-white  md:flex md:px-24 lg:px-40 xl:px-52 2xl:px-72">
            <div className="w-3/4 md:w-1/3 lg:w-1/3 2xl:w-1/3 ">
              <h1 className="font-sans text-5xl text-ll-primaryYellow xl:text-6xl 2xl:text-7xl">Little Lemon</h1>
              <h3 className=" mb-4 text-2xl lg:text-2xl xl:text-3xl 2xl:text-4xl">Chicago</h3>
        ...
        <section id="menu-cards">
          <div className="  mt-16 px-0 md:px-24  lg:mt-32 lg:px-40 xl:px-52 2xl:px-72">
            <div className=" mt-24 flex items-center justify-between px-4">
              <h3 className=" font-mono text-2xl font-bold md:text-3xl lg:text-4xl xl:text-5xl">This weeks specials!</h3>
              <Link
                href="/menu"
        ...
        <section id="testimonials" className=" mt-32 bg-ll-primaryGreen pb-14 pt-14 lg:mt-64">
          <div className=" px-4 md:px-24 lg:px-40 xl:px-52 2xl:px-72">
            <h3 className=" mb-8 font-mono text-2xl font-bold text-white md:text-3xl lg:text-4xl xl:text-5xl">Testimonials</h3>
        ...
        <section id="about-us" className=" mt-32 px-4 pb-14 pt-14 md:px-24 lg:mt-64 lg:px-40 xl:px-52 2xl:px-72">
          <div className="grid justify-between lg:flex">
            <div className=" lg:w-1/3">
              <h2 className=" mb-8 font-mono text-2xl font-bold md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-5xl">About Owners</h2>
              <p className=" mb-4 font-mono lg:mb-12 xl:text-lg 2xl:text-xl">
            ...
            <div className=" relative mx-auto  mt-12 pl-6  lg:mx-0 lg:mt-0 lg:pt-8 xl:pt-8 2xl:pt-0 ">
              <Image src="/images/Mario and Adrian b.jpg" width={300} height={300} alt="Cooking Image" className=" relative z-0 w-auto xl:w-96"></Image>
              <Image
