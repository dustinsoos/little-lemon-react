      ...
      <main>
        ...
        {isSubmitted && (
          <section className=" ">
            <div
              id="signup-success"
              className=" mx-auto mb-64 mt-64  w-full rounded-2xl  bg-ll-primaryGreen p-14 text-center font-mono text-xl text-white shadow-xl shadow-black/50 md:w-1/2  xl:w-1/3 "
            >
