    ...
    <>
      <main>
        <section className=" mt-16 bg-ll-primaryGreen pb-28 pt-28">
          <h1 className=" text-center font-sans text-5xl text-ll-primaryYellow xl:text-6xl 2xl:text-7xl">Reserve A Table</h1>
        </section>
        <form
          id="my-form"
          action=""
        ...
        >
          <p className="mb-4 text-2xl text-ll-primaryYellow">Thanks {name} for reserving a table with Little Lemon!</p>
